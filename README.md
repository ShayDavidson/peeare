...
Troubled by the fact Github UI doesn't allow querying PRs by multiple authors, even in the same repo? Worry not! With the `peeare` shell command you can track your entire team's pull requests across multiple repos! 
